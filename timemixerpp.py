...
from pypots.nn.modules.revin import RevIN
from pypots.nn.modules.timemixerpp.layers import MixerBlock
from pypots.nn.modules.transformer import ScaledDotProductAttention, MultiHeadAttention
...
if __name__ == "__main__":
    ...
    args.test_data_path = 'ETTh1.csv'
    args.is_training = True
    args.model_id = 'ETTh1_96_96'
    args.model = 'TimeMixerPP'
    args.data = 'ETTh1'
    args.features = 'M'
    args.seq_len = 96
    args.label_len = 0
